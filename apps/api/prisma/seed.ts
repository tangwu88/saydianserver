...
async function main(): Promise<void> {
  ...
  for (const [key, state, publicConfig] of [
    ...
    ["email_otp", IntegrationState.UNCONFIGURED, { provider: null, deliveryVerified: false }],
    ["sms_global", IntegrationState.UNCONFIGURED, { provider: null, deliveryVerified: false, countries: [] }],
