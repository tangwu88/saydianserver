...
.catalog-side { display:grid; grid-template-columns:repeat(auto-fit,minmax(142px,1fr)); align-items:stretch; gap:10px; }.side-title,.help-link { display:none; }
.category-link { display:grid; grid-template-columns:42px minmax(0,1fr) auto; align-items:center; gap:10px; width:100%; min-width:0; min-height:64px; white-space:nowrap; border:1px solid #e2e9ef; border-radius:16px; background:linear-gradient(145deg,#fff,#f5f9fc); padding:8px 12px; font-size:14px; margin:0; text-align:left; box-shadow:0 5px 14px rgba(28,72,104,.06); }.category-link::after{border:0}.category-icon{width:40px;height:40px;display:grid;place-items:center;overflow:hidden;border-radius:13px;background:#e8f3ff;color:#005bad;font-weight:800}.category-icon image{width:30px;height:30px}.category-all .category-icon{background:#005bad;color:#fff}.category-name { min-width:0; overflow:hidden; text-overflow:ellipsis; font-weight:650; }.category-arrow { color:#005bad;font-size:22px;line-height:1; }
.catalog-main { min-width:0; }.section-title { margin:22px 0 16px; font-size:22px; display:flex;align-items:center;width:100%;}.section-title .text-button{width:auto;margin-left:auto;padding-inline:0}.referral-line { color:var(--green); font-size:14px; margin:12px 0; }
@media(max-width:360px) { .catalog-side { grid-template-columns:repeat(2,minmax(0,1fr)); } }
@media(min-width:900px) { .mobile-brand {display:none;} .home-page {padding-top:24px;}.store-banners {height:280px;margin-bottom:32px;} .banner {padding:20px 60px;} .banner-title {font-size:36px;max-width:500px;} .banner image {width:40%;}.banner-copy {padding:20px;}.catalog-layout {display:grid;grid-template-columns:248px minmax(0,1fr);gap:30px;align-items:start;}.catalog-side {display:grid;grid-template-columns:1fr;background:#fff;padding:22px;border:1px solid #e4ebf0;border-radius:20px;box-shadow:0 10px 26px rgba(28,72,104,.07)}.side-title {display:block;font-size:20px;font-weight:800;margin:0 0 6px 2px;}.category-link {width:100%;min-height:58px;padding:8px 10px;border-radius:14px;font-size:15px;}.category-link:hover{border-color:#8bb8dc;transform:translateY(-1px)}.category-icon{width:38px;height:38px}.help-link {display:block;margin:10px 0 0;font-size:14px;background:#f1f5f8;}.section-title {margin:0 0 22px;}.product-grid {grid-template-columns:repeat(3,minmax(0,1fr));gap:20px;} }
</style>
