...
export const fieldContracts = {
  "AuthController.login": record(object({ mobile: string, username: string, password: string }, ["password"]), { mobile: "<TEST_MOBILE>", password: "<TEST_PASSWORD>" }, session, sessionExample, authSource),
  ...
  "AuthController.resetPassword": record(object({ mobile: string, code: string, password: string, newPassword: string }, ["mobile", "code"]), { mobile: "<TEST_MOBILE>", code: "<SMS_CODE>", password: "<NEW_TEST_PASSWORD>" }, session, sessionExample, authSource),
