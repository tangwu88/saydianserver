...
- 工具测试锁定两个保活参数，防止后续误删。
- 保活修复后镜像全部拉取完成，4 个迁移状态正常，新 API 健康；首次单次后台页请求在启动竞态中返回 `curl` 退出码 22，触发自动回滚。
- 最终 smoke 验收改为分别重试 `/admin/` 和 `/down`，最多 20 次、间隔 3 秒；持续不可用仍会失败并回滚。
...
- 2026-09-06T17:32:08.5622440Z：pnpm api:docs:check，退出码 0。

- 2026-09-06T17:32:14.5946290Z：pnpm tools:test，退出码 0。

- 2026-09-06T17:32:20.2654450Z：pnpm typecheck，退出码 0。

- 2026-09-06T17:32:24.8737200Z：pnpm test，退出码 0。

- 2026-09-06T17:32:35.7854730Z：pnpm build，退出码 0。
