...
- 首次离线包组合验证命令被本机执行策略在进程启动前拒绝（命令包含递归删除临时解压目录）；没有创建 ZIP、没有删除文件、没有改变仓库。改为拆分步骤，并使用只读 ZipArchive 流对照 SHA-256，不再创建/删除临时解压目录。
...
- 2026-09-05T03:57:37.1820753Z：pnpm.cmd api:docs:check，退出码 0。

- 2026-09-05T03:57:48.7889449Z：pnpm.cmd tools:test，退出码 0。

- 2026-09-05T03:58:00.4008215Z：pnpm.cmd typecheck，退出码 0。

- 2026-09-05T03:58:09.4064887Z：pnpm.cmd test，退出码 0。

- 2026-09-05T03:58:28.7184442Z：pnpm.cmd build，退出码 0。
